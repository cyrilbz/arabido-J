# arabido-J
The objective of this repository is to provide solutions for the analysis of (Arabidopsis) plant trays with ImageJ/FIJI. This work has been done in the framework of the AdapTest project.
